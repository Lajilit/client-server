...
from client.server_interaction_thread import ClientServerInteraction
...
if __name__ == '__main__':
    ...
    try:
        server_int = ClientServerInteraction(server_address, server_port, database, client_name, client_password, keys)
